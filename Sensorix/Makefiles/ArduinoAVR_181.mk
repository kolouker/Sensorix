...
#
#
# Last update: Nov 06, 2017 release 8.2.5
...
PLATFORM         := Arduino
BUILD_CORE       := avr
PLATFORM_TAG      = ARDUINO=10801 ARDUINO_ARCH_AVR ARDUINO_$(BUILD_BOARD) EMBEDXCODE=$(RELEASE_NOW) $(filter __%__ ,$(GCC_PREPROCESSOR_DEFINITIONS))
APPLICATION_PATH := $(ARDUINO_PATH)
